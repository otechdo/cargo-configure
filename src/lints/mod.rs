use crate::{
    clippy::{
        ...
        BORROW_INTERIOR_MUTABLE_CONST_LINTS, IF_LET_MUTEX_LINTS, LET_AND_RETURN_LINTS,
        LET_UNDERSCORE_UNTYPED_LINTS, LET_WITH_TYPE_UNDERSCORE_LINTS,
    },
    config::Lint,
};

const LINTERS: usize = 31;
...
const BORROW_INTERIOR_MUTABLE_CONST_LINT: (Lint, Lint, Lint) = BORROW_INTERIOR_MUTABLE_CONST_LINTS;
const BORROW_AS_PTR_LINT: (Lint, Lint, Lint) = BORROW_AS_PTR_LINTS;
const BIND_INSTEAD_OF_MAP_LINT: (Lint, Lint, Lint) = BIND_INSTEAD_OF_MAP_LINTS;
const BIG_ENDIAN_BYTES_LINT: (Lint, Lint, Lint) = BIG_ENDIAN_BYTES_LINTS;
const BORROW_DEREF_REF_LINT: (Lint, Lint, Lint) = BORROW_DEREF_REF_LINTS;
...
pub const NOVICE_LINTS: [Lint; LINTERS] = [
    ...
    BORROWED_BOX_LINT.0,
    BORROW_INTERIOR_MUTABLE_CONST_LINT.0,
    BORROW_AS_PTR_LINT.0,
    BIND_INSTEAD_OF_MAP_LINT.0,
    BIG_ENDIAN_BYTES_LINT.0,
];

#[doc = "All lints for expert"]
pub const EXPERT_LINTS: [Lint; LINTERS] = [
    BORROW_DEREF_REF_LINT.1,
    ABSOLUTE_PATH.1,
    ASSIGNING_CLONES.1,
    ...
    BORROWED_BOX_LINT.1,
    BORROW_INTERIOR_MUTABLE_CONST_LINT.1,
    BORROW_AS_PTR_LINT.1,
    BIND_INSTEAD_OF_MAP_LINT.1,
    BIG_ENDIAN_BYTES_LINT.1,
];

#[doc = "All lints for master"]
pub const MASTER_LINTS: [Lint; LINTERS] = [
    BORROW_DEREF_REF_LINT.2,
    ABSOLUTE_PATH.2,
    ASSIGNING_CLONES.2,
    ...
    BORROWED_BOX_LINT.2,
    BORROW_INTERIOR_MUTABLE_CONST_LINT.2,
    BORROW_AS_PTR_LINT.2,
    BIND_INSTEAD_OF_MAP_LINT.2,
    BIG_ENDIAN_BYTES_LINT.2,
];
