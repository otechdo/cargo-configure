...
use crate::clippy::assigning_clones::{
    EXPERT_ASSIGN_CLONE_LINT, MASTER_ASSIGN_CLONE_LINT, NOVICE_ASSIGN_CLONE_LINT,
};
use crate::clippy::rc_clone_in_vec_init::{
    EXPERT_RC_CLONE_IN_VEC_INIT_LINT, MASTER_RC_CLONE_IN_VEC_INIT_LINT,
    NOVICE_RC_CLONE_IN_VEC_INIT_LINT,
};
use crate::config::ClippyLint;

const LINTERS: usize = 13;
#[doc = "All lints for novice"]
pub const NOVICE_LINTS: [ClippyLint; LINTERS] = [
    ...
    NOVICE_RC_CLONE_IN_VEC_INIT_LINT,
    NOVICE_ASSIGN_CLONE_LINT,
    NOVICE_AS_UNDERSCORE_LINT,
];

#[doc = "All lints for expert"]
pub const EXPERT_LINTS: [ClippyLint; LINTERS] = [
    ...
    EXPERT_ASSIGN_CLONE_LINT,
    EXPERT_RC_CLONE_IN_VEC_INIT_LINT,
];

#[doc = "All lints for master"]
pub const MASTER_LINTS: [ClippyLint; LINTERS] = [
    ...
    MASTER_RC_CLONE_IN_VEC_INIT_LINT,
    MASTER_ASSIGN_CLONE_LINT,
];
