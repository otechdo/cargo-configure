use crate::{
    clippy::{
        ...
        ARITMETIC_SIDE_EFFECTS_LINTS, ASSERTIONS_ON_CONSTANTS_LINTS, ASSIGNING_CLONES_LINTS,
        ASSIGN_OP_PATTERN_LINTS, ASYNC_YIELDS_ASYNC_LINTS, AS_CONVERSIONS_LINTS,
        AS_PTR_CAST_MUT_LINTS, AS_UNDERSCORE_LINTS, AWAIT_HOLDING_INVALID_TYPE_LINTS,
        AWAIT_HOLDING_LOCK_LINTS, BLOCKS_IN_CONDITIONS_LINTS,
    },
    config::Lint,
};

const LINTERS: usize = 17;
