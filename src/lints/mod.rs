use crate::{
    clippy::{
        ...
        AWAIT_HOLDING_INVALID_TYPE_LINTS, AWAIT_HOLDING_LOCK_LINTS, BIND_INSTEAD_OF_MAP_LINTS,
        BLANKET_CLIPPY_RESTRICTION_LINTS_LINTS, BLOCKS_IN_CONDITIONS_LINTS, BOOL_COMPARISON_LINTS,
        BOOL_TO_INT_WITH_IF_LINTS, BORROWED_BOX_LINTS, BORROW_AS_PTR_LINTS,
