...
#[doc = "The lint id"]
const ID: &str = "absurd_extreme_comparisons";

#[doc = "The description of the lint"]
const DESCRIPTION: &str = "Checks for comparisons where one side of the relation is either the minimum or maximum value for its type and warns if it involves a case that is always true or always false. Only integer and boolean types are checked.";

#[doc = "The default clippy lint group"]
const GROUP: LintGroup = LintGroup::Correctness;
...
const RECOMMENDED_SEVERITY: LintSeverity = LintSeverity::Deny;
...
#[doc = "The novice lint"]
pub const NOVICE_ABSURD_EXTREME_COMPARISON_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_ABSURD_EXTREME_COMPARISON_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_ABSURD_EXTREME_COMPARISON_LINT: ClippyLint = lint(&Master);
