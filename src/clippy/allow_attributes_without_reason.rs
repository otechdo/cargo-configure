...
#[doc = "The lint id"]
const ID: &str = "allow_attributes_without_reason";

#[doc = "The description of the lint"]
const DESCRIPTION: &str = "Checks for attributes that allow lints without a reason.";
...
#[doc = "The novice lint"]
pub const NOVICE_ALLOW_ATTRIBUTE_WITHOUT_REASON_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_ALLOW_ATTRIBUTE_WITHOUT_REASON_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_ALLOW_ATTRIBUTE_WITHOUT_REASON_LINT: ClippyLint = lint(&Master);
