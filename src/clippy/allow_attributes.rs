...
#[doc = "The novice lint"]
pub const NOVICE_ALLOW_ATTRIBUTE_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_ALLOW_ATTRIBUTE_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_ALLOW_ATTRIBUTE_LINT: ClippyLint = lint(&Master);
