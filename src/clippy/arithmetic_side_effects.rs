...
pub const ARITHMETIC_SIDE_EFFECT_DESCRIPTION: &str =
...
pub const ARITHMETIC_SIDE_EFFECT_ISSUE: Option<&'static str> =
    Some("https://github.com/rust-lang/rust-clippy/issues?q=is%3Aissue+arithmetic_side_effects");
