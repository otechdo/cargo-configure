...
pub const ASYNC_YIELDS_ASYNC_DESCRIPTION: &str =
...
pub const ASYNC_YIELDS_ASYNC_ISSUE: Option<&'static str> =
    Some("https://github.com/rust-lang/rust-clippy/issues?q=is%3Aissue+async_yields_async");
