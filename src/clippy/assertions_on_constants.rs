...
pub const ASSERTIONS_ON_CONSTANTS_DESCRIPTION: &str =
...
pub const ASSERTIONS_ON_CONSTANTS_ISSUE: Option<&'static str> =
    Some("https://github.com/rust-lang/rust-clippy/issues?q=is%3Aissue+assertions_on_constants");
