...
#[doc = "The lint id"]
const ID: &str = "almost_swapped";

#[doc = "The description of the lint"]
const DESCRIPTION: &str = "Checks for foo = bar; bar = foo sequences.";

#[doc = "The default clippy lint group"]
const GROUP: LintGroup = LintGroup::Correctness;

#[doc = "The applicability group"]
const APPLICABILITY: Applicability = Applicability::MaybeIncorrect;
...
#[doc = "The novice lint"]
pub const NOVICE_ALMOST_COMPLETE_RANGE_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_ALMOST_COMPLETE_RANGE_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_ALMOST_COMPLETE_RANGE_LINT: ClippyLint = lint(&Master);
