...
const RECOMMENDED_SEVERITY_FOR_NOVICE: LintSeverity = LintSeverity::Allow;
...
#[doc = "The novice lint"]
pub const NOVICE_ABSOLUTE_PATH_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_ABSOLUTE_PATH_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_ABSOLUTE_PATH_LINT: ClippyLint = lint(&Master);
