...
#[doc = "The lint id"]
const ID: &str = "as_underscore";

#[doc = "The description of the lint"]
const DESCRIPTION: &str = "Checks for the usage of as _ conversion using inferred type.";
...
#[doc = "The novice lint"]
pub const NOVICE_AS_UNDERSCORE_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_AS_UNDERSCORE_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_AS_UNDERSCORE_LINT: ClippyLint = lint(&Master);
