...
pub const AWAIT_HOLDING_INVALID_DESCRIPTION: &str =
...
pub const AWAIT_HOLDING_INVALID_ISSUE: Option<&'static str> =
    Some("https://github.com/rust-lang/rust-clippy/issues?q=is%3Aissue+await_holding_invalid_type");
