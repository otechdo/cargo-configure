...
pub const BIG_ENDIAN_BYTES_DESCRIPTION: &str =
...
pub const BIG_ENDIAN_BYTES_WHATS_BAD: &str =
    "To ensure use of little-endian or the target endianness rather than big-endian.";
#[doc = "The big endian bytes uri issue"]
pub const BIG_ENDIAN_BYTES_ISSUE: Option<&'static str> =
    Some("https://github.com/rust-lang/rust-clippy/issues?q=is%3Aissue+big_endian_bytes");
