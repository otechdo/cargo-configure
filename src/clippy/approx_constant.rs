...
#[doc = "The lint id"]
const ID: &str = "approx_constant";

#[doc = "The description of the lint"]
const DESCRIPTION: &str = "Checks for floating point literals that approximate";
...
#[doc = "The novice lint"]
pub const NOVICE_APPROX_CONSTANT_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_APPROX_CONSTANT_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_APPROX_CONSTANT_LINT: ClippyLint = lint(&Master);
