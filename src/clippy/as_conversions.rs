...
#[doc = "The lint id"]
const ID: &str = "as_conversions";

#[doc = "The description of the lint"]
const DESCRIPTION: &str = "Checks for usage of as conversions.";
...
#[doc = "The novice lint"]
pub const NOVICE_AS_CONVERSIONS_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_AS_CONVERSIONS_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_AS_CONVERSIONS_LINT: ClippyLint = lint(&Master);
