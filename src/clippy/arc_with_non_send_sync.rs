...
#[doc = "The lint id"]
const ID: &str = "arc_with_non_send_sync";
...
#[doc = "The novice lint"]
pub const NOVICE_ARC_WITH_NO_SEND_SYNC_LINT: ClippyLint = lint(&Novice);

#[doc = "The expert lint"]
pub const EXPERT_ARC_WITH_NO_SEND_SYNC_LINT: ClippyLint = lint(&Expert);

#[doc = "The master lint"]
pub const MASTER_ARC_WITH_NO_SEND_SYNC_LINT: ClippyLint = lint(&Master);
